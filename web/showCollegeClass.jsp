...
<head>
    ...
    <script>
        ...
        function open_CollegeClassDetail(get_collegeclassid) {
            var url = "/studentDetails?method=findCollegeClassStudentByCollegeClassid&CollegeClassID=" + get_collegeclassid + "&page=1";
            window.location=url;
        };
        function exportCollegeGradeDetails() {
            var url1 ="/teacherExport?method=exportAllGrade";
    ...
    <div class="jumbotron">
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <button  type="button" class="btn btn-info" rel="external nofollow" onclick="exportCollegeGradeDetails()">
            ...
            <table class="table table-bordered table-hover text-center">
                ...
                <tbody>
                    <c:forEach items="${list}" var="collgeclassshow">
                        <tr>
                            <td>${collgeclassshow.grade}</td>
                            <td>${collgeclassshow.collegeclassname}</td>
                            <td>${collgeclassshow.studentnumber}</td>
                            <td>
                                <button type="button" id="${collgeclassshow.collegeclassid}" name="open_btn" class="btn btn-info"
                                        rel="external nofollow"
                                        value="/WeekCountShow?WeekCountID=${collgeclassshow.collegeclassid}"
                                        onclick="open_CollegeClassDetail(this.id)">展开
                                </button>
                            </td>
                        </tr>
                    </c:forEach>
