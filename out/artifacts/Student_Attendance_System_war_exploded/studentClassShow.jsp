...
<head>
    ...
    <script>
        ...
        function open_classWeekCountDetail(get_open_classid, get_studentid) {
            var url = "/studentClass?method=findWeekCountByClassid&classid=" + get_open_classid + "&studentid=" + get_studentid;
            window.location=url;
        }
    </script>
</head>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="/studentClass?method=findAll">所有</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="/studentClass?method=findByGrade&Grade=2016">2016级</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="/studentClass?method=findByGrade&Grade=2017">2017级</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="/studentClass?method=findByGrade&Grade=2018">2018级</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="/studentClass?method=findByGrade&Grade=2019">2019级</a>
                            </div>
                        </li>
                    </ul>
                    <form class="form-inline my-2 my-lg-0" method="post" action="/studentClass">
                        <input class="form-control mr-sm-2" type="search" placeholder="查询班级" aria-label="Search"
                               name="searchClassName" id="searchClassName">
            ...
            <table class="table table-bordered table-hover text-center">
                ...
                <c:forEach items="${list}" var="classshow">
                    <tr>
                        ...
                        <td>${classshow.teacher}</td>
                        <td>${classshow.courseid}</td>
                        <td>${classshow.coursename}</td>
                        <td>${classshow.classname}</td>
                        <td>
                            <button type="button" id="${classshow.classid}" name="open_btn" class="btn btn-info"
                                    rel="external nofollow"
                                    value="${curUserID}"
                                    onclick="open_classWeekCountDetail(this.id, this.value)">展开
                            </button>
                        </td>
                    </tr>
                </c:forEach>
