...
<head>
    ...
    <script>
        ...
        function open_HighWarning(get_collegeclassid) {
            var url = "/studentWarning?method=findHighWarningByCollegeClassid&CollegeClassID=" + get_collegeclassid;
            window.location=url;
        };
        function open_MiddleWarning(get_collegeclassid) {
            var url = "/studentWarning?method=findMiddleWarningByCollegeClassid&CollegeClassID=" + get_collegeclassid;
            window.location=url;
        };
        function open_LowWarning(get_collegeclassid) {
            var url = "/studentWarning?method=findLowWarningByCollegeClassid&CollegeClassID=" + get_collegeclassid;
            window.location=url;
        };
    ...
    <div class="jumbotron">
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="dropdown">
                    <a class="btn btn-info dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="glyphicon glyphicon-save">导出学生绩点</span>
                    </a>
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <a class="dropdown-item" href="/teacherExport?method=exportHighWarningStudentGPA">高风险</a>
                        <a class="dropdown-item" href="/teacherExport?method=exportMiddleWarningStudentGPA">中风险</a>
                        <a class="dropdown-item" href="/teacherExport?method=exportLowWarningStudentGPA">无风险</a>
                    </div>
                </div>
            </nav>
            <br>
            ...
            <table class="table table-bordered table-hover text-center">
                ...
                <tbody>
                    <c:forEach items="${list}" var="collgeclassshowlearn">
                        <tr>
                            <td>${collgeclassshowlearn.grade}</td>
                            <td>${collgeclassshowlearn.collegeclassname}</td>
                            <td>
                                <button type="button" name="open_btn" class="btn btn-danger disabled"
                                        rel="external nofollow">${collgeclassshowlearn.highwarning}
                                </button>
                                <button type="button" id="${collgeclassshowlearn.collegeclassid}" name="open_btn" class="btn btn-info"
                                        rel="external nofollow"
                                        onclick="open_HighWarning(this.id)">展开
                                </button>
                            </td>
                            <td>
                                <button type="button" name="open_btn" class="btn btn-warning disabled"
                                        rel="external nofollow">${collgeclassshowlearn.middlewarning}
                                </button>
                                <button type="button" id="${collgeclassshowlearn.collegeclassid}" name="open_btn" class="btn btn-info"
                                        rel="external nofollow"
                                        onclick="open_MiddleWarning(this.id)">展开
                                </button>
                            </td>
                            <td>
                                <button type="button" name="open_btn" class="btn btn-success disabled"
                                        rel="external nofollow">${collgeclassshowlearn.lowwarning}
                                </button>
                                <button type="button" id="${collgeclassshowlearn.collegeclassid}" name="open_btn" class="btn btn-info"
                                        rel="external nofollow"
                                        onclick="open_LowWarning(this.id)">展开
                                </button>
                            </td>
                        </tr>
                    </c:forEach>
